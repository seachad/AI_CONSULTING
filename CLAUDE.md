...
- 18-09-2026: inventario de artefactos de trabajo y huecos en `SEVEN-G/mds/es/_trabajo/20260918_Inventario_de_artefactos_y_huecos_SEVEN-G.md` Resuelto el 19-09-2026 con D67 (plantillas editables en Word, `SEVEN-G/build/docx.ps1`, que `build.ps1` ejecuta) y D68 (plantillas P32–P71, T11 con T13 y T15). Pendiente del autor: revisión jurídica de P47, P48, P49, P51 y P56; validar la regla de P14 «una cláusula exigida ausente bloquea el uso con datos de producción salvo riesgo aceptado» (no está en 36); decidir si 21 añade un criterio de G3/G4 para el plan de realización de beneficios (P62), que el glosario trata como evidencia (añadirlo exige ampliar `catalogo_criterios.json` de T01); alinear los sobres de 13 §12 con las partidas de 14 §6.1; y decidir si los mandos intermedios (PER-PB) necesitan perfil F propio en 31 §6.2 y cuál es el umbral de alfabetización (IND-ADO-05 100 % frente a PER-02 ≥ 90 %). Fuera de v0.x: expediente del proveedor de alto riesgo (anexo IV, sistema de calidad, declaración UE de conformidad). Si cambia el cuestionario del documento 11, regenerar T15 con `build_madurez.ps1 -ActualizarCuestionario`. T14 (índice de transformación) disponible desde el 18-09-2026 (D64); se genera con `pwsh -File SEVEN-G/herramientas/T14_indice_transformacion/build_indice.ps1`. Siguientes pasos propuestos al autor: esquema 0.4 de T01 (verificación IT-P2/IT-P3, horas materializadas y reasignadas —T20—, oferta habilitada por IA —T12—), T18 como módulo de T01 (señal 8) y bloque del índice en T17. Calibrar los umbrales v0.1 del índice con datos reales.
