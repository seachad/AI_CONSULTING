...
- 18-09-2026: inventario de artefactos de trabajo y huecos en `SEVEN-G/mds/es/_trabajo/20260918_Inventario_de_artefactos_y_huecos_SEVEN-G.md` (unos 60 artefactos de compañía, consejo, cumplimiento, terceros y auditoría sin plantilla; ninguna plantilla rellenable; referencias rotas a P16, P17, P26, P28 y P15/P21/P22). Pendiente del autor: formato rellenable (.docx/.xlsx o HTML), codificación P32+, alcance del expediente de proveedor de alto riesgo y orden de las olas (§9). T14 (índice de transformación) disponible desde el 18-09-2026 (D64); se genera con `pwsh -File SEVEN-G/herramientas/T14_indice_transformacion/build_indice.ps1`. Siguientes pasos propuestos al autor: esquema 0.4 de T01 (verificación IT-P2/IT-P3, horas materializadas y reasignadas —T20—, oferta habilitada por IA —T12—), T18 como módulo de T01 (señal 8) y bloque del índice en T17. Calibrar los umbrales v0.1 del índice con datos reales.
