...
- 18-09-2026: inventario de artefactos de trabajo y huecos en `SEVEN-G/mds/es/_trabajo/20260918_Inventario_de_artefactos_y_huecos_SEVEN-G.md` Resuelto el 19-09-2026 con D67 (plantillas editables en Word, `SEVEN-G/build/docx.ps1`, que `build.ps1` ejecuta) y D68 (plantillas P32–P71, T11 con T13 y T15). Los demás pendientes se cerraron con D69 (sobres, plan de realización en G3.05/G4.11, regla de proveedores en 36, perfil F9 y umbral de alfabetización, alcance del proveedor de alto riesgo). Pendiente del autor: **revisión jurídica de P47, P48, P49, P51 y P56** antes de ofrecerlas a una compañía, y calibrar el umbral de renovación de la alfabetización (PER-PC ≥ 90 %). Si cambia el cuestionario del documento 11, regenerar T15 con `build_madurez.ps1 -ActualizarCuestionario`. T14 (índice de transformación) disponible desde el 18-09-2026 (D64); se genera con `pwsh -File SEVEN-G/herramientas/T14_indice_transformacion/build_indice.ps1`. Siguientes pasos propuestos al autor: esquema 0.4 de T01 (verificación IT-P2/IT-P3, horas materializadas y reasignadas —T20—, oferta habilitada por IA —T12—), T18 como módulo de T01 (señal 8) y bloque del índice en T17. Calibrar los umbrales v0.1 del índice con datos reales.
