...
```mermaid
flowchart LR
  B1["01 · Framing · 10 min"] --> B2["02 · Value spheres · 12 min"]
  B2 --> B3["03 · Enablers · 10 min"]
  B3 --> B4["04 · Regulation · 10 min"]
  B4 --> B5["05 · People · 8 min"]
  B5 --> B6["06 · Governance and 90 days · 10 min"]
```
...
```mermaid
flowchart LR
  S["Session with the board: mandate"] --> M1["Month 1: current map with evidence"]
  M1 --> M2["Month 2: risks and opportunities by sphere"]
  M2 --> M3["Month 3: ambition by sphere and governance"]
  M3 --> C["Board: approval and quarterly follow-up"]
```
