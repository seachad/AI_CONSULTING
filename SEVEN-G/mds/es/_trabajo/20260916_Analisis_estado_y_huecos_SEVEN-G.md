...
8. **NIST CSF 2.0, Cyber AI Profile, perfiles del AI RMF e ISO/IEC 42001 (25-09-2026, D110–D112):** entregas 1 a 3 del encargo `20260925_Encargo_sesion_local_NIST_CSF_AI_RMF_42001.md` hechas: mapeo del CSF en 34 §5.3 y columna «Función CSF» en el 35; perfiles por subcategoría en 34 §5.4–§5.5 con la escala 0–5 y equivalencia a los *tiers* en 11 §2.2 y §7.5; plantillas P72, P73 y P74 (la biblioteca pasa a 74 plantillas). Pendiente del autor: validar la asignación de funciones CSF y las correspondencias con el cuestionario del 11, revisión jurídica o por un auditor de 42001 de P74 y decidir las entregas 4 (T15, T01 0.7, T17) y 5 (contenido «Defend» en el 35).
