...
<!-- esencial: siempre | Proceso de no conformidades con plazos y registro, y gestión de incidentes de IA con severidad S1 a S4. Es una de las siete condiciones para declarar que se aplica SEVEN-G. Las notificaciones regulatorias solo aplican cuando la norma obliga. -->
...
- **Reglamento (UE) 2024/1689** (Reglamento de IA), arts. 3.49, 26.5, 72 y 73, modificado por el Reglamento (UE) 2026/1744 (Ómnibus digital sobre IA), que no modifica el texto del art. 73 (aunque el nuevo art. 75.1 bis dispone que los proveedores bajo competencia de la Oficina Europea de IA le notifiquen a ella los incidentes graves) y aplaza al 2 de diciembre de 2027 las obligaciones de los sistemas de alto riesgo del anexo III.
...
- **Directiva (UE) 2022/2555 (NIS2)**, art. 23. En España seguía siendo un anteproyecto, sin remitir a las Cortes Generales, en septiembre de 2026; el 8-07-2026 la Comisión Europea llevó a España ante el Tribunal de Justicia de la UE por no haber notificado la transposición (IP/26/1499).
...
- **Modelos de propósito general con riesgo sistémico.** Sus proveedores tienen obligaciones propias de notificación a la Oficina Europea de IA (art. 55); la compañía, como usuaria, colabora a través del contrato (documento 36).
