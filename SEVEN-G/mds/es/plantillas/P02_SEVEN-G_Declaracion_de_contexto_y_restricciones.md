...
| DORA (Reglamento (UE) 2022/2554) | | Solo entidades financieras incluidas en su ámbito. | Riesgo de proveedores TIC, incidentes, funciones críticas o importantes. | |
...
| Accesibilidad **(Enterprise)** | | Productos o servicios incluidos en la normativa europea de accesibilidad. | | |
