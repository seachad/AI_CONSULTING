...
| 6 | Para entidades sujetas a DORA, se consideran las funciones esenciales o importantes que la entidad haya identificado (terminología oficial de DORA en español). |
