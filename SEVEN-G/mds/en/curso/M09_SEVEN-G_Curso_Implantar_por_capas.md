# Module 09 · Implementing in layers

**Where to start, what is mandatory from day one and what is added only when it is needed**

| | |
|---|---|
| Document | Course · Module 09 |
...
<!-- cifras: 25 | minutes ; 90 | days of the initial plan ; 3 | reading layers ; 12 | rules that are never omitted -->
...
By the end you will be able to choose your company's implementation scope, distinguish what is mandatory from what is proportionate and prepare the start of a 90-day plan.
...
1. A medium-sized company launches a single Transform bet. Does its implementation scope change?
