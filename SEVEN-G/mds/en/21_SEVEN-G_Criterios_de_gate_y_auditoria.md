...
| G3.05 | The expected net value is consistent with the risk appetite and the return horizon set in C2. | P10 · P08 | Yes | Yes | Yes | Optimise: positive expected annual net value within the horizon. Augment: in addition, feasibility of adoption and of the role change. Transform: feasibility of the first stage, stop criteria per stage and documented option value. |
...
| G4.11 | There is an adoption plan with training, communication, support and measurement of use. | P20 · T20 | Conditionable | Simpl. | Yes | Optimise: how released capacity will be realised. Augment: role change and capacity reallocation. Transform: change in the operating model for the first stage. |
