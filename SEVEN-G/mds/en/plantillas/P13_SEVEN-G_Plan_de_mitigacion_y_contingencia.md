...
| **Tool** | T06 · Risk matrix and register: records the response, controls and contingency plan of each risk; treatment actions with owner, deadline and status are tracked in this template. The Excel of the use case generated by T06 proposes, for each registered risk, mitigation actions (section 4) and a contingency plan (section 6) from the catalogue in document 33 §9, with the columns of this template to be completed: it is the starting point, not the approved plan. |
