...
<!-- esencial: recomendado | The full recurring cost of each case is mandatory under the measurement rules (document 40). Analytical allocation, total cost of ownership and cost per unit of output are applied in proportion to the size of the portfolio; the consumption budget, when cost depends on usage. -->
