...
| **Notification** | The deployer notifies the market surveillance authority of the results, using the template provided by the European AI Office, under the terms of Article 27(3) and (5). |
