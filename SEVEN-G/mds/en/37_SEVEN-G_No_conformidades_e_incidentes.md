...
- **Regulation (EU) 2024/1689** (AI Act), Arts. 3(49), 26(5), 72 and 73, as amended by Regulation (EU) 2026/1744 (Digital Omnibus on AI), which does not amend the text of Art. 73 (although new Art. 75(1a) provides that providers under the competence of the EU AI Office report serious incidents to that Office) and postpones to 2 December 2027 the obligations for the high-risk systems listed in Annex III.
...
- **Directive (EU) 2022/2555 (NIS2)**, Art. 23. In Spain it was still a preliminary draft, not sent to the Cortes Generales, in September 2026; on 8-07-2026 the European Commission referred Spain to the Court of Justice of the EU for failing to notify its transposition (IP/26/1499).
