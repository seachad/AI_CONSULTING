...
foreach ($lang in $Idiomas) {
  ...
  foreach ($f in (Get-ChildItem $dir -File -Filter $Filter | Where-Object Extension -eq '.md' | Sort-Object Name)) {
    ...
    $pieTxt = if ($lang -eq 'en') { "SEVEN-G · Template $codigo · $titulo · CC BY 4.0 · Fernando García Varela · Generated from the Markdown source: do not edit the template, fill in a copy." } else { "SEVEN-G · Plantilla $codigo · $titulo · CC BY 4.0 · Fernando García Varela · Generada desde la fuente Markdown: no edite la plantilla, rellene una copia." }
    ...
    $core = "<?xml version=""1.0"" encoding=""UTF-8"" standalone=""yes""?><cp:coreProperties xmlns:cp=""http://schemas.openxmlformats.org/package/2006/metadata/core-properties"" xmlns:dc=""http://purl.org/dc/elements/1.1/"" xmlns:dcterms=""http://purl.org/dc/terms/"" xmlns:xsi=""http://www.w3.org/2001/XMLSchema-instance""><dc:title>$(Xml "$codigo · $titulo")</dc:title><dc:creator>Fernando García Varela</dc:creator><dc:language>$lang</dc:language><dc:description>sha256:$huella</dc:description><cp:keywords>SEVEN-G</cp:keywords></cp:coreProperties>"
    $partes = @{
