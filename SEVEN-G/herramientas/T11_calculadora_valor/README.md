...
**Con el registro T01 en el mismo navegador** (D100): el registro de iniciativas es la fuente de verdad y, servidas desde el sitio, las herramientas comparten el almacenamiento local, así que «Nuevo desde un registro T01…» ofrece directamente las iniciativas del registro guardado (sin ficheros) y el enlace «Calcular la hipótesis de valor con esta iniciativa (T11)» de la pestaña Valor de la ficha de T01 abre T11 con el caso de esa iniciativa creado (o el que ya existía). Un T11 recién abierto con un registro real toma su compañía y retira los casos de ejemplo. El caso recuerda su iniciativa (`iniciativa_t01`) y **«Guardar los importes esperados de este caso en el registro T01»** escribe en la iniciativa los importes esperados del caso (eficiencias, retorno, capacidad liberada, coste recurrente e inversión), siempre como esperados y con fuente T11, más un evento de edición; T01 los muestra en la pestaña Valor. Si el registro no está en el navegador, «Cargar un fichero de T01…» y la exportación del resultado del caso (`valores_t01`, que T01 incorpora con «Validar y fusionar») hacen lo mismo por ficheros. **«Actualizar este caso desde el registro»** (D102) vuelve a leer la iniciativa: renueva nombre, ambición, intensidad y fase, los importes que siguen «desde T01» (cada línea importada recuerda su importe de origen) y añade los importes esperados nuevos; una línea cuyo importe se cambió a mano o que se descompuso en unidades × valor unitario se conserva, y una que ya no está en el registro se señala. Al abrir T11 desde la ficha de T01 con un caso ya existente, se actualiza solo.
